-- VERIFICAR NUMERO DE CONEXOES ABERTAS
...
"VIVO TELEFONIA S.A"
"RESTAURANTE SINATRA (SETOR BANCÁRIO NORTE)"
"LOTÉRICA (SETOR BANCÁRIO NORTE)"
...
INSERT INTO PUBLIC.TABLE_FAVORECIDO VALUES(NEXTVAL('SEQUENCE_FAVORECIDO'), 'QG JEITINHO CASEIRO (SETOR BANCÁRIO NORTE)');
INSERT INTO PUBLIC.TABLE_CANAL_PAGAMENTO VALUES(NEXTVAL('SEQUENCE_CANAL_PAGAMENTO'), TRUE, 'PAGAMENTO REALIZADO NO CAIXA');
...
ORDER BY TABLE_DESPESA_VARIAVEL_.DATA_DESPESA ASC;
